...
module.exports = (app) => {
  ...
  router.post(
    ...
    [
      isAuthenticated,
      uploadHandler(uploadChecklist.any("images")),
      resizeImage,
    ],
  ...
  router.get("/:id", [isAuthenticated], tb_checklistchitiet.getDetail);

  router.get("/", [isAuthenticated], tb_checklistchitiet.getCheckList);
