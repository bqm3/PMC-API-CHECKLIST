...
module.exports = (app) => {
  ...
  router.get(
    "/report-external-incident-percent-week",
    tb_sucongoai.getSuCoBenNgoai
  );
  router.post(
    "/report-uploads",
    [isAuthenticated, upload.single("files")],
    tb_sucongoai.uploadReports
  );

  // ===================================
  router.get(
    "/chi-nhanh-report-external-incident-percent-week",
    [isAuthenticated, isAdmin],
    tb_sucongoai.getSuCoBenNgoaiChiNhanh
  );
  router.get(
    "/chi-nhanh-su-co-ngoai",
    [isAuthenticated, isAdmin],
    tb_sucongoai.getSuCoNamChiNhanh
  );
  router.get(
    "/chi-nhanh-dashboard",
    [isAuthenticated, isAdmin],
